...
const Photos = () => {
  const posts = [{ photos: ["/photos/petrified.jpg"], description: "Petrified Forest National Park", date: "2021, SECOND YEAR OF COLLEGE", ratio: 1 },
                ...
                { photos: ["/photos/math-team.jpg"], description: "Me and Desi Nainar (1st place two person team) at the Math Team state competition", date: "2017, SOPHOMORE YEAR OF HIGH SCHOOL", ratio: 1 }]
  return (
