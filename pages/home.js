      ...
      <>
        ...
        <div className={styles.appContainer}>
          <div>
            <div className={styles.appRow}>
              <AppIcon destination={"/about"} name="About Me" destinationInSite={true} image="/icons/wikipedia.png" />
        ...
        <div className={styles.bottomBar}>
          <div className={styles.appRow}>
            ...
            <AppIcon destination={"/about"} name="" destinationInSite={true} image="/icons/wikipedia.png" bottom />
